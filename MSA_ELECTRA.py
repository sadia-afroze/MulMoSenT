...
from transformers import get_linear_schedule_with_warmup, AdamW, AutoConfig, AutoModel, BertConfig, ElectraForPreTraining, ElectraTokenizer, ElectraModel
...
class CustomDataLoaderLP(Dataset):
    def __init__(self,csv_file):
        ...
        self.tokenizer = ElectraTokenizer.from_pretrained('monsoon-nlp/bangla-electra')
    def __len__(self):
        return self.samples
...
class ELECTRA(torch.nn.Module):
    def __init__(self, num_labels=6):
        ...
        self.config = AutoConfig.from_pretrained("monsoon-nlp/bangla-electra", num_labels=6)
        self.config.return_dict = True
        self.model = ElectraModel.from_pretrained("monsoon-nlp/bangla-electra", return_dict=True)
...
def ValidateELECTRA(temp_model):
...
def TrainELECTRA():
    ...
    for epoch in range(20):
        ...
        accuracy = ValidateELECTRA(model)
        print(f".......................{epoch}.......................\n")
        if accuracy > best_accuracy:
            best_accuracy = accuracy
            best_model = model
    torch.save(best_model, "./mmbtc-6-model/ELECTRA_model.pt")
