...
class mT5_ViT_MFB(nn.Module):
    ...
    def forward(self, input_ids, attention_mask, decoder_input_ids=None, decoder_inputs_embeds=None):
        ...
        mfb_output = self.linear(text_output)
...
def TrainTextModel():
    ...
    for epoch in range(epoch):
        ...
        if acc > globalACC:
            globalACC = acc
            torch.save(model.state_dict(), './mT5.pth')
